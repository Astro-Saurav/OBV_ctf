...
|---|----------|---------|------------|--------|------|
| 01 | 📞 The Caller | Audio Steganography (DTMF Tones) & Jump Scare | 🟢 Easy | 200 | `BVAULT{d7mf_70n35_4r3_cr33py}` |
| 02 | 👻 Phantom Document | Invisible Ink & XMP Metadata | 🟢 Easy | 200 | `BVAULT{ph4n70m_m374d474_r3v34l3d}` |
| 03 | 💀 Cursed Disk | Disk Forensics (FAT32 File Carving) | 🟡 Medium | 450 | `BVAULT{d3l373d_f1l35_n3v3r_d13}` |
| 04 | 🕸️ Ghost in the Wires | PCAP Analysis (HTTP Object Extraction) | 🟡 Medium | 450 | `BVAULT{gh057_1n_7h3_pc4p_n37w0rk}` |
| 05 | 🦇 Polymorphic Nightmare | Polyglot (PNG+ZIP) & Hex Editing | 🔴 Hard | 700 | `BVAULT{p0lygl07_f1l35_4r3_n1gh7m4r35}` |
| 06 | 🧠 Schizophrenic Malware | Advanced PCAP (DNS Exfiltration) | 🔴 Hard | 700 | `BVAULT{dns_exf1l7r4710n_m4lw4r3_c4u9h7}` |
